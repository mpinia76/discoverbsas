...
$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
			VALUES ('".$_SESSION['useridbsas']."','".$_SESSION['usernombrebsas']."','Creacion y Conciliacion de Cajas','".getRealIP()."')";
...
function add_transferencia_suc(){
	createWindow('w_<?php echo $tabla?>_transferencia_suc_add','Agregar transferencia intersucursal','cajas_transferencia_suc.am.php','600','400'); //botones
}
...
<ul id="menu">
    ...
    <?php if(ACCION_144){ ?><li onclick="add_transferencia_suc()" class="item"><img src="images/bt_transfer.png" align="absmiddle" />  Transferencias intersucursal</li><?php } ?>
    ...
    <?php if(ACCION_140){ ?><li onclick="add_conversion()" class="item"><img src="images/bt_transfer.png" align="absmiddle" />  Cambio Moneda</li><?php } ?>
