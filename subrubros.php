...
$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
			VALUES ('".$_SESSION['useridbsas']."','".$_SESSION['usernombrebsas']."','Subrubros de Gastos y Compras','".getRealIP()."')";
mysqli_query($conn,$sql);
$tabla 	= "subrubro"; //tabla
$label 	= "subrubro"; //nombre para el editar y agregar
$file 	= "subrubros.php"; //archivo
$json	= "subrubros.json.php"; //json
$abm 	= "subrubros.am.php"; //agregar o modificar
...
function doInitGrid(){
    ...
    mygrid.setHeader("Rubro,Subrubro,Activo"); 		//nombre de las columnas
    mygrid.setInitWidths("*,*,40"); 				//ancho de las columnas
    mygrid.setColAlign("left,left,center");			//alineacion de las columnas
