<div id="menu" style="display:none; width: 320px; background: #fff; padding: 10px;">
    ...
    <?php } ?>
        ...
        <?php } ?>
        <?php if(ACCION_111){ ?>
      	<div class="operaciones item" onclick="createWindow('w_ventas_grilla','Grilla de reservas','v2/informes/index_ventas_grilla2','1230','600'); $('#menu').hide();">
            Grilla de reservas 2
        </div>
        <?php } ?>
        <?php if(ACCION_118){ ?>
      	<div class="operaciones item" onclick="createWindow('w_ventas_check','Check de disponibilidad','v2/reservas/index_check','500','600'); $('#menu').hide();">
        ...
        <?php } ?>
        <?php if(MENU_41){?>
        <div class="administracion item" onclick="createWindow('w_formulario_DJ230','Formulario DJ230 AREF','formulario_DJ230.php','400','200'); $('#menu').hide();">
            Formulario DJ230 AREF
        </div>
        <?php } ?>
        <?php if(MENU_42){?>
        ...
        <?php } ?>
         <?php if(MENU_39){?>
        <div class="configuracion item" onclick="createWindow('w_canales','Canales de venta','v2/canals/index','600','400'); $('#menu').hide();">
            Canales de venta
        </div>
        <?php } ?>
         <?php if(MENU_38){?>
        ...
        <?php } ?>
        <?php if(MENU_28){?>
        <div class="configuracion item" onclick="createWindow('w_unidads','Unidades','v2/unidads/index','750','500'); $('#menu').hide();">
            Administraci&oacute;n de flota
        </div>
        <?php } ?>

        <?php if(MENU_35){?>
        <div class="configuracion item" onclick="createWindow('w_lugars','Lugares','v2/lugars/index','600','500'); $('#menu').hide();">
            Locaciones Retiro/Devoluci&oacute;n
        </div>
        <?php } ?>
        <?php if(MENU_29){?>
        ...
        <?php } ?>
        <?php if(MENU_31){?>
        <div class="configuracion item" onclick="createWindow('w_extras','Menu de Extras y Valorizacion','v2/extras/index','600','500'); $('#menu').hide();">
        ...
        <?php } ?>
        <?php if(MENU_33){?>
        <div class="configuracion item" onclick="createWindow('w_marca_tarjetas','Actualizador de Marcas de tarjeta','v2/marca_tarjetas/index','600','400'); $('#menu').hide();">
            Actualizador de Marcas de tarjeta
        </div>
        <?php } ?>
        <?php if(MENU_33){?>
        ...
        <?php } ?>
        <?php if(MENU_34){?>
        <div class="configuracion item" onclick="createWindow('w_cobro_tarjeta_cuotas','Cuotas y Coheficientes','v2/cobro_tarjeta_cuotas/index','600','500'); $('#menu').hide();">
        ...
        <div class="configuracion item" onclick="createWindow('w_configuracion_monto','Configuracion del sistema','configuracion.am.php','600','400'); $('#menu').hide();">
            Gastos, Compras, Impuestos, Tasas y Cargas sociales: Montos Aprobaci&oacute;n
        </div>
        <?php } ?>
        <?php if(ACCION_97){?>
       ...
       <?php if(MENU_43){?>
        ...
        <?php } ?>
        <?php if(ACCION_104){ ?>
      	<div class="informes item" onclick="createWindow('w_ventas_informe_operaciones','Listado de operaciones','v2/informes/index_ventas_operaciones','1230','600'); $('#menu').hide();">
        ...
        <?php } ?>
        <?php if(ACCION_112){ ?>
      	<div class="informes item" onclick="createWindow('w_ventas_informe_ocupacion_x_categoria','Informe de ocupacion por categoria','v2/informes/index_ventas_ocupacion_x_categoria','1230','600'); $('#menu').hide();">
            Informe de ocupacion por categoria
        </div>
        <?php } ?>
        <?php if(ACCION_116){ ?>
      	<div class="informes item" onclick="createWindow('w_ventas_informe_ocupacion_porcentaje','Informe de Ocupaci&oacute;n/D&iacute;as x Mes','v2/informes/index_ventas_ocupacion_porcentaje','1230','600'); $('#menu').hide();">
            Informe de Ocupaci&oacute;n/D&iacute;as x Mes
        </div>
        <?php } ?>
           <?php if(ACCION_120){ ?>
    ...
    <?php } ?>
        ...
        <div class="onLine item" onclick="createWindow('w_configuracion_reservas','Configuracion reservas On Line','configuracion.reservas.php','600','400'); $('#menu').hide();">
            Activar reservas On Line
        </div>
        <?php } ?>

        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_coheficientes_categorias','Coheficientes por categorias','v2/categorias/index_coheficientes','1230','400'); $('#menu').hide();">
            Coheficientes por categorias
        </div>
        <?php } ?>
        <?php if(ACCION_121){ ?>
        <div class="onLine item" onclick="createWindow('w_estadia_categorias','Estadia minima','v2/categorias/index_estadia','1230','400'); $('#menu').hide();">
            Estadia minima
        </div>
        <?php } ?>

        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_habilitar_categorias','Habilitar Categorias','v2/categorias/index2','600','400'); $('#menu').hide();">
		Habilitar Categor&iacute;as</div>
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_habilitar_unidads','Habilitar Unidades','v2/unidads/index2','750','500'); $('#menu').hide();">
            Habilitar Unidades
        </div>
        <?php } ?>
         <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_habilitar_tarjetas','Habilitacion de tarjetas en la web','v2/cobro_tarjeta_tipos/index2','600','500'); $('#menu').hide();">
            Habilitacion de tarjetas en la web
        </div>
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_habilitar_tarjetas_cuotas','Habilitacion de cuotas de tarjetas web','v2/cobro_tarjeta_cuotas/index2','600','500'); $('#menu').hide();">
            Habilitacion de cuotas de tarjetas web
        </div>
        <?php } ?>
       <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_semana_dias','Horarios Retiro-Devolucion','v2/semana_dias/index_horarios','600','400'); $('#menu').hide();">
            Horarios Retiro-Devolucion
        </div>
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_descuentos','Opciones de Cobro/descuentos','v2/descuentos/index','800','400'); $('#menu').hide();">
            Opciones de Cobro/descuentos
        </div>
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_extra_subrubros','Parametrizacion Extras web','v2/extra_subrubros/index2','600','500'); $('#menu').hide();">
            Parametrizacion Extras web
        </div>
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_tarifas_categorias','Tarifas por categorias','v2/categorias/index_tarifas','1230','400'); $('#menu').hide();">
            Tarifas por categorias
        </div>
        <?php } ?>
         <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_hora_adicional','Valor hora adicional','v2/hora_adicionals/index','600','400'); $('#menu').hide();">
            Valor hora adicional
        </div>
        <?php } ?>
        <?php if(MENU_40){?>
        <div class="onLine item" onclick="createWindow('w_seguros','Valores seguro x dia','v2/seguros/index','600','400'); $('#menu').hide();">
            Valores seguro x dia
        </div>
        <?php } ?>
