...
$form = new Form();
$form->setLegend('Transferencia'); //nombre del form
$form->setAction('transferencias_movimientos.am.php'); //a donde hacer el post
...
if(isset($dataid)){
	...
	$form->setBotonValue('Editar'); //leyendo del boton
	$form->setBotonName('editar');
	$form->setId($dataid);

}else{

	$form->setBotonValue('Agregar'); //leyenda del boton
