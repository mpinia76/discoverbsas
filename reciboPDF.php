...
$oPdf->MultiCell( 185, 6, 'Recibí de Discover Buenos Aires Rent a Car, la suma de '.Format_toMoney($rsSueldo['monto']).' correspondiente a'.$haberes.'del mes de '.$meses[$rsSueldo['mes']]. ' de '.$rsSueldo['ano'], '','L');
$oPdf->Output();
?>
