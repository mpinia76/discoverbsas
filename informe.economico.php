...
$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
			VALUES ('".$_SESSION['useridbsas']."','".$_SESSION['usernombrebsas']."','Informes economico - Egresos','".getRealIP()."')";
...
<select name="espacio_trabajo">
			...
			if ($_SESSION['adminbsas']) {
				...
				WHERE usuario.id = ".$_SESSION['useridbsas']."
			...
			while($rs = mysqli_fetch_array($rsTemp)){
				if (!$espacio_trabajo&&!$_SESSION['adminbsas']) {
