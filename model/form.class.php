...
class Form{
	...
	public function setCampos($campos){
		...
		foreach($campos as $columna=>$valor){
			...
			switch($valor[0]){
				...
				case 'combo':
				$this->createCombo($columna,$valor[1],$valor[2],$valor[3],$valor[4],$valor[5],$valor[6],$valor[7]);
				break;
	...
	public function createCombo($name, $label, $required = 0, $value = '', $tabla, $campo_id, $campo, $comment = ''){
