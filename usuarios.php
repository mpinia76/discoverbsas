...
$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
			VALUES ('".$_SESSION['useridbsas']."','".$_SESSION['usernombrebsas']."','Administracion de Usuarios','".getRealIP()."')";
mysqli_query($conn,$sql);
$tabla 	= "usuario"; //tabla
$label 	= "usuario"; //nombre para el editar y agregar
$file 	= "usuarios.php"; //archivo
$json	= "usuarios.json.php"; //json
$abm 	= "usuarios.am.php"; //agregar o modificar
