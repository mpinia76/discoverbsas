...
$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
			VALUES ('".$_SESSION['useridbsas']."','".$_SESSION['usernombrebsas']."','Tarjetas Corporativas','".getRealIP()."')";
mysqli_query($conn,$sql);
$tabla 	= "tarjeta"; //tabla
$label 	= "tarjeta"; //nombre para el editar y agregar
$file 	= "tarjetas.php"; //archivo
$json	= "tarjetas.json.php"; //json
$abm 	= "tarjetas.am.php"; //agregar o modificar
