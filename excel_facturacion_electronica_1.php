...
WHERE R.id IN (".$ids.") ORDER BY devolucion, C.nombre_apellido ASC";
...
while($rs = mysqli_fetch_array($rsTemp)){
	if(($rs['estado']!='2')&&($rs['estado']!='3')){
		...
		mysqli_query($conn,"DELETE FROM reserva_factura_procesada WHERE reserva_id = ".$rs['id']." AND cliente = '".trim($rs['nombre_apellido'])."' AND dni = '".trim($rs['dni'])." AND total = '".$total."'");

		$insert = "INSERT INTO reserva_factura_procesada (reserva_id,fecha,cliente,dni,total) VALUES (".$rs['id'].",'".date('Y-m-d H:i:s')."','".trim($rs['nombre_apellido'])."','".trim($rs['dni'])."','".$total."')";
...
<td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;"><?php echo str_replace('-', '', $rs['devolucion']);?></td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;">PES</td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;">1</td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;"><?php echo $rsPuntos['numero'];?></td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;">0</td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;"> </td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;"> </td>
    <td style="font-family: Arial; font-size: 10pt; text-align:center;border: 0.1pt solid black;vertical-align: middle;">1</td>
