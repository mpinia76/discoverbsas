...
$sql = "INSERT INTO usuario_log (usuario_id,nombre,accion,ip)
			VALUES ('".$_SESSION['useridbsas']."','".$_SESSION['usernombrebsas']."','Rubros de Gastos y Compras','".getRealIP()."')";
mysqli_query($conn,$sql);
$tabla 	= "rubro"; //tabla
$label 	= "rubro"; //nombre para el editar y agregar
$file 	= "rubros.php"; //archivo
$json	= "rubros.json.php"; //json
$abm 	= "rubros.am.php"; //agregar o modificar
...
function doInitGrid(){
    ...
    mygrid.setHeader("Rubro,Gastos y compras,Impuestos tasas y Cargas Sociales,Activo"); 		//nombre de las columnas
    mygrid.setInitWidths("*,*,*,*"); 				//ancho de las columnas
    mygrid.setColAlign("left,center,center,center");			//alineacion de las columnas
