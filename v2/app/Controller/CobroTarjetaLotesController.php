...
class CobroTarjetaLotesController extends AppController {
    ...
    count(CobroTarjeta.id) as operaciones'), 'group' => array('CobroTarjeta.cobro_tarjeta_tipo_id', 'CobroTarjeta.lote HAVING '.$filtroMonto.' AND '.$filtroOperaciones ), 'conditions' => $condicion,'order' => $order, 'conditions' => $condicion, 'limit'=>$limit, 'recursive' => -1));
