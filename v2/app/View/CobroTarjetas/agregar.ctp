...
<div class="ym-grid">
    <div class="ym-g25 ym-gl"><div class="ym-gbox"><?php echo $this->Form->input('CobroTarjeta.posnet_id',array('label' => 'Terminal','options' => $posnets, 'empty' => 'Seleccionar...')); ?></div></div>
