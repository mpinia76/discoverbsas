    ...
    <tr class="contenido">
        <td class="mes">Ventas totales</td>
        <?php for($i=1; $i<=12; $i++){ ?>
    ...
    <tr class="contenido">
        ...
        <?php for($i=1; $i<=12; $i++){ ?>
        <td><?php echo $unidades_activas[$i]?></td>
        <?php } ?>
        <td>&nbsp;</td>
    </tr>
    <tr class="contenido">
    ...
    <tr class="contenido">
        ...
        <td><?php 
        $capacidad=0;
        if($capacidad_total[$i]!=0){
        	$capacidad=number_format(($capacidad_ocupada[$i] / $capacidad_total[$i])*100,2);
        }
        echo $capacidad;
        ?>%</td>
        <?php } ?>
    ...
    <tr class="contenido">
        <td class="mes">Tarifa por unidad ocupada</td>
        <?php for($i=1; $i<=12; $i++){ 
            if($capacidad_ocupada[$i] > 0){ ?>
            <td><?php 
             $capacidad=0;
	        if($capacidad_ocupada[$i]!=0){
	        	$capacidad=number_format($ventas_netas[$i]/$capacidad_ocupada[$i],2);
	        }
	        echo $capacidad;
            ?></td>
        <?php }else{ ?>
    ...
    <!--<tr class="contenido">
        <td class="mes">Tarifa media diaria / unidad</td>
        <?php for($i=1; $i<=12; $i++){ ?>
