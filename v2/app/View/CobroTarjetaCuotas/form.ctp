...
echo $this->Form->hidden('CobroTarjetaCuota.activa');
echo $this->Form->input('CobroTarjetaCuota.posnet_id',array('options' => $posnets, 'empty' => 'Seleccionar', 'type'=>'select', 'label' => 'Terminal', 'value' => $cobro_tarjeta_cuota['CobroTarjetaTipo']['cobro_tarjeta_posnet_id']));
...
echo $this->Form->input('CobroTarjetaCuota.mascara_web',array('label' => 'Mascara WEB','type'=>'text', 'class'=>'number'));
