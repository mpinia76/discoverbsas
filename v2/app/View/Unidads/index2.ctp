    ...
    oTable = $("#dataTable").dataTable( {
        ...
        "fnDrawCallback": function( oSettings ) {
            $("#dataTable tr").unbind("dblclick").dblclick(function(){
                ...
                createWindow("w_unidads_view","Ver unidad","'.$this->Html->url('/unidads/editar2', true).'/"+data[0],"450","300");
            });
        ...
        "aaSorting": [],
		"sAjaxSource": "'.$this->Html->url('/unidads/dataTable2', true).'",
        "bDeferRender": true,
        "aoColumns": [
           {"bVisible": false },
            null,
...
function editar(){
    ...
    if(row.length == 0){
        ...
        createWindow("w_unidads_view","Ver unidad","<?php echo $this->Html->url('/unidads/editar2', true);?>/"+data[0],"450","300");
