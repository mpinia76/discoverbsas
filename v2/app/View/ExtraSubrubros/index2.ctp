    ...
    oTable = $("#dataTable").dataTable( {
        ...
        "fnDrawCallback": function( oSettings ) {
            $("#dataTable tr").unbind("dblclick").dblclick(function(){
                ...
                createWindow("w_subrubros_view","Ver extra subrubro","'.$this->Html->url('/extra_subrubros/editar2', true).'/"+data[0],"450","300");
            });
        ...
        "aaSorting": [],
		"sAjaxSource": "'.$this->Html->url('/extra_subrubros/dataTable2', true).'",
        "bDeferRender": true,
        "aoColumns": [
            {"bVisible": false },
            null,
...
function editar(){
    ...
    if(row.length == 0){
        ...
        createWindow("w_extra_subrubros_view","Ver extra subrubro","<?php echo $this->Html->url('/extra_subrubros/editar2', true);?>/"+data[0],"450","300");
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
    <thead>
        <tr>
            ...
            <th width="100">Impacto</th>
            <th width="150">Disponible venta on line</th>
