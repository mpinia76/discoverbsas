...
function devolucion(){
    ...
    if(row.length == 0){
        ...
        var data = oTable.fnGetData(row[0]);
        createWindow("w_reservas_devolucion","Devoluciones de reserva","/discoverbsas/reserva_devoluciones.php?reserva_id="+data[0],"830","400");
    }
}
function voucher(){
    var row = $("#dataTable tr.row_selected");
...
function contrato(){
    ...
    if(row.length == 0){
        ...
        var data = oTable.fnGetData(row[0]);
        document.location = "<?php echo $this->Html->url('/reservas/contrato', true);?>/"+data[0];
    }
}
...
<ul class="action_bar">
    ...
    <li class="boton pdf"><a onclick="contrato();">Contrato</a></li>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
    <thead>
        <tr>
            ...
            <th width="250">Unidad</th>
            <th width="150">Retiro</th>
            <th width="150">Devolucion</th>
            <th width="100">Alquiler</th>
